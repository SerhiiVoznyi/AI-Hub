...
- [orchestrated-aws-lambda-nodejs-story.md](./orchestrated-aws-lambda-nodejs-story.md): same flow, fixed Node.js / AWS Lambda skill manifest, story under `## Story`; **Cursor** workspace is a sibling of `AI-Hub`, with agents/skills read from the hub and implementation under the open project.
